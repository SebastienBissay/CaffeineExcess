...
public final class Parameters {
    ...
    public static final int NUMBER_OF_RECURSIONS = 20000;
    public static final float DIVISION_PROBABILITY = .5f;
    public static final float GAUSSIAN_NOISE_AMOUNT = 3.5f;
